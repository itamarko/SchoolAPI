...
namespace SchoolAPI.Data
{
    public class SchoolDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Student>().HasData(new Student { Id = 1, FirstName = "John", LastName = "Doe" });
            modelBuilder.Entity<Student>().HasData(new Student { Id = 2, FirstName = "Mira", LastName = "Doe" });
        }
    }
}
